...
class STAIRCASE:
    ...
    def __init__(self, path_input, name_input, dic):
        ...
        dic["sigma_early"] = list(beta_sigma_ERW[:, 0])
        dic["sigma_random"] = list(beta_sigma_ERW[:, 2])
        dic["sigma_wearout"] = list(beta_sigma_ERW[:, 4])
        dic["beta_early"] = list(beta_sigma_ERW[:, 5])
        dic["beta_random"] = list(beta_sigma_ERW[:, 3])
        dic["beta_wearout"] = list(beta_sigma_ERW[:, 5])
